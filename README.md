Here’s the same content with **Real-World Architecture Benefits** moved up to position #3:
...
* **10,000 I/O operations**: 1.0 ms write, 0.8 ms read
...
* 2–10 ms for comparable I/O operations
...
## 3. Real-World Architecture Benefits
...
* Scale from 100 to 1 M+ sensors seamlessly
...
## 5. True Concurrent Architecture
...
| 25 M    | 100    | 15.8 µs   | 0.158 µs       | +8.5 µs  |

**Key Insight**: 250,000× more signals adds only 8.5 µs – true O(1) scalability!
...
We're not accepting external contributions at this time, but we appreciate your interest!
...
We plan to open contributions in the future with proper CLA infrastructure. Follow the project to be notified!
